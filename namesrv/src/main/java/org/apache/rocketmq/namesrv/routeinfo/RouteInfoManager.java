...
public class RouteInfoManager {
    ...
    public DataVersion queryBrokerTopicConfig(final String brokerAddr) {
        ...
        return prev == null ? null : prev.getDataVersion();
    }
    ...
    /**
     * 创建和更新 topic 信息,确保最新的 topic info 保存到 topic table 中
     *
     * @param brokerName
     * @param topicConfig
     */
